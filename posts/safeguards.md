...
date: 2026-02-09
categories: ["Policy"]
image: "../media/image-20260209081527258.png"
lightbox: true
format:
  html:
    include-after-body:
...
![Policy reviews](../media/image-20260208155720245.png){#fig-policy-reviews}
...
![Top emitters by industry](../media/image-20260208160200386.png){#fig-top-emitters}
...
![Australia's global carbon footprint](../media/image-20260208162507758.png){#fig-Grant,Hare Climat Analytics 2023}
...
![Emissions projections](../media/image-20260209081527258.png){#fig-emissions-projections}
...
![ACCU abatement by source](../media/image-20260209082947524.png){#fig-accu-abatement}
...
![ACCU consumption via Safeguards](../media/image-20260209091617086.png){#fig-accu-consumption}
...
1. Is the 4.9% annual baseline decline rate appropriate for post-2030?
2. Should the facility threshold be lowered from 100,000 tonnes CO2-e to capture more emitters?
3. Should the scheme move from facility-level to organisation-level coverage?
4. Are current offset arrangements (ACCUs and SMCs) appropriate, or should limits be imposed?
5. How should new entrant facilities (particularly fossil fuel projects) be treated?
6. What is the pathway for baselines to reach net zero by 2049-50?
7. How does the scheme interact with Australia's 2035 NDC target (62-70% reduction)?
8. Are trade-exposed baseline-adjusted (TEBA) facility provisions working effectively?
...
**Current settings:** The 4.9% annual decline rate applies only to 2030. For 2030-31 to 2049-50, an indicative rate of **3.285%** is set in the Safeguard Rules [@dcceew-safeguard-overview]. However, actual post-2030 rates will be determined through the 5-year baseline setting process.
