...
| ------------------------------------------------------------ | -------------- | ----------- | :-------: | ---------------- | ------------------------------------------------------------ |
| [Gas Market](#gas-market)                                    | Implementation | Not open    |     ✗     | DCCEEW/DISR/ACCC | Domestic reservation scheme (15-25%); LNG netback methodology |
| [DMO Framework](#default-market-offer-dmo-implementation)    | Implementation | Closed      |     ✓     | AER              | Electricity price caps; tariff caps; embedded networks; Solar Sharer Offer |
| [NEM Wholesale Market](#nem-wholesale-market-settings-review) | Implementation | Closed      |     ✓     | Energy Ministers | Market liquidity; Market-Making Obligation; ESEM             |
| [Cheaper Home Batteries](#cheaper-home-batteries-program)    | Active         | N/A         |     —     | DCCEEW           | ~200k installations; \$7.2B program; 2M batteries by 2030    |
| [Electric Car Discount](#electric-car-discount-review)       | Review         | Open        |     ✗     | Treasury/DCCEEW  | FBT exemption effectiveness; \$1.35B cost; PHEV eligibility  |
| [National EV Strategy](#national-electric-vehicle-strategy-review) | Pending        | Not open    |     ✗     | DCCEEW           | Uptake progress; charging infrastructure; regional equity    |
| [Safeguard Mechanism](#safeguard-mechanism-review)           | Pending        | Not open    |     ✗     | DCCEEW           | Post-2030 decline rates; offset limits; 2035 NDC alignment   |
...
![Australian emissions by sector](../media/image-20260120205448751.png){#fig-carbon-scorecard}
...
![Australia trade balance](../media/image-20260120212141077.png){#fig-trade-balance}
...
![Global EV market trends](../media/image-20260121095015968.png){#fig-global-ev-market}
...
| Market | Direct Subsidy | Tax/Registration Saving | Other Benefits | Total Benefit |
|:-------|---------------:|------------------------:|---------------:|--------------:|
| Norway | — | ~\$50,000 (purchase tax exemption) | VAT ~\$5,000; tolls, parking | **~\$55,000+** |
| Denmark | — | ~\$40,000 (150%+ registration tax avoided) | — | **~\$40,000** |
| China | ~\$6,000 | Varies by city | License plate ~\$20,000 (Shanghai) | **\$6,000–26,000** |
...
2. **ZEV mandates provide certainty that subsidies cannot** - manufacturers respond to binding requirements; subsidy-only approaches require unsustainably high levels (\$40,000/vehicle) to achieve equivalent outcomes [@acs-zev-subsidies-2025]

3. **Policy complementarity matters** - subsidies and infrastructure reinforce each other; weakening one policy reduces effectiveness of others [@rff-ev-investments-2025]

4. **Tax differentials outperform direct subsidies** - Norway's tax exemptions (worth 70% of ICE price) and Denmark's registration tax system create sustained price signals without ongoing fiscal cost [@norwegian-ev-association; @oecd-norway-2021]

5. **Driving privileges provide additional adoption incentive** - license plate priority (China), bus lane access (Norway), and LEZ exemptions (EU) reduce ownership friction, with measurable adoption effects [@icct-china-city-2023; @jenn-hov-2018]
...
| ------ | ----------------: |
| 2009-2022 (subsidies + tax breaks) | \$40-60 billion AUD |
| 2009-2023 (all support types)[^csis-estimate] | \$230 billion USD |
| 2024-2027 (tax incentive package) | \$105 billion AUD |

*Source: CSIS; Ministry of Industry and Information Technology*

[^csis-estimate]: CSIS estimate includes direct subsidies, tax exemptions, government procurement, R&D funding, and infrastructure investment.

---

## References

1. [If You Build It, They Will Come: Lessons from the First Decade of Electric Vehicles](https://blogs.worldbank.org/en/transport/if-you-build-it-they-will-come-lessons-first-decade-electric-vehicles) — Rode et al., World Bank, 2022. Analysis finding charging infrastructure explains 69% of cross-country EV share variance vs 17% for subsidies; infrastructure investment is 4-7x more cost-effective than subsidies.

2. [Should Government Incentivize EV Adoption Through Consumer Tax Credits or Infrastructure?](https://www.cmu.edu/tepper/news/stories/2025/0522-should-government-incentivize-ev-adoption-through-consumer-tax-credits-or-infrastructure) — Carnegie Mellon University Tepper School of Business, 2025. Research finding redirecting funds from tax credits to charging infrastructure could increase EV adoption by 26% and reduce emissions by 51%.

3. [Subsidies, Standards, or Both? Trade-Offs among Policies for 100% Zero-Emissions Vehicle Sales](https://pubs.acs.org/doi/10.1021/acs.est.4c11772) — Axsen & Bhardwaj, Environmental Science & Technology, 2025. Finding ZEV mandates cost \$50-150/tonne CO2e abated vs $450-820/tonne for subsidy-only approaches; subsidies require \$40,000/vehicle to achieve 100% ZEV sales.

4. [A Tale of Two Investments: Charging Stations and Purchase Subsidies for EV Adoption](https://www.rff.org/publications/working-papers/a-tale-of-two-investments-charging-stations-and-purchase-subsidies-for-ev-adoption/) — Resources for the Future, 2025. Research demonstrating policy complementarity: charging station density positively influences how important consumers consider purchase subsidies.

5. [Norwegian EV Policy](https://elbil.no/english/norwegian-ev-policy/) — Norwegian EV Association (Norsk elbilforening), 2025. Overview of Norway's EV incentive package including VAT exemption, registration tax exemption, reduced tolls, and bus lane access.

6. [Norway's Evolving Incentives for Zero-Emission Vehicles](https://www.oecd.org/en/publications/ipac-policies-in-practice_22632907-en/norway-s-evolving-incentives-for-zero-emission-vehicles_22d2485b-en.html) — OECD, 2021. Analysis of Norway's fiscal incentives including exemption from registration tax, VAT, and motor fuel taxes; tax expenditure reached NOK 11.3 billion (USD 1.3 billion) in 2021.

7. [Accelerating New Energy Vehicle Uptake in Chinese Cities](https://theicct.org/publication/pv-chinese-cities-nev-policies-feb23/) — International Council on Clean Transportation, 2023. Assessment of city-level policies including preferential license plate access, traffic restriction exemptions, and use-phase incentives.

8. [Effectiveness of electric vehicle incentives in the United States](https://www.sciencedirect.com/science/article/abs/pii/S0301421518302891) — Jenn, Springel & Gopal, Energy Policy, 2018. Research finding HOV lane access increases EV adoption by 4.7% per unit of lane density; every $1,000 rebate increases EV sales by 2.6%.

9. [How Will the Dual-Credit Policy Help China Boost New Energy Vehicle Growth?](https://theicct.org/china-dual-credit-policy-feb22/) — International Council on Clean Transportation, 2022. Explanation of China's dual credit system where NEV credits can offset fuel consumption deficits but not vice versa, forcing manufacturers to produce EVs.
